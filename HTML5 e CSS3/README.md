...
A primeira linha do documento deve ser o <code> < !DOCTYPE html></code>, apesar de parecer um elemento HTML ela apenas diz ao navegador que ele está lidando com um arquivo do tipo HTML5. Os elementos HTML vem logo abaixo.
...
Vamos abrir nosso arquivo index.html e começar pelo cabeçalho: criamos um <code>header</code> logo abaixo do **body** e colocamos o título da nossa página dentro de um **h1**

Depois criaremos a lista de postagens: abrimos um elemento section e dentro dele adicionamos outro <code>header</code> contendo um **h2**. Notem que eu posso ter mais de um <code>header</code> na página.
